...
<AnimatePresence>
  {activeTableTicket && (() => {
    ...
    return (
      <>
        <motion.div initial={false} animate={{ opacity: 0.65 }}
  ...
  <motion.div key="customers" initial={false} animate={{opacity:1}} style={{display:'flex',flexDirection:'column',gap:'20px'}}>
    ...
    <AnimatePresence>
      {customerProfile && (
        <>
          <motion.div
            initial={false} animate={{opacity:0.6}}
  ...
  {extraItemEditData.price && extraItemEditData.costPrice && (
    <div style={{ fontSize: '0.58rem', color: '#4ade80', marginTop: '4px' }}>
      ...
      <AnimatePresence>
        {confirmModal.show && (
          <div style={styles.modalBackdrop}>
            <motion.div initial={false} animate={{scale:1,opacity:1}} style={styles.confirmBox}>
...
<AnimatePresence>
  {purchaseOrderModal && (
    <>
      {/* Backdrop */}
      <motion.div
        initial={false} animate={{ opacity: 0.65 }}
